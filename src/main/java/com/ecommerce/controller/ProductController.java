...
public class ProductController {
	...
	public ResponseEntity<Page<Product>> findProductByCategoryHandler(@RequestParam String category,
			...
			@RequestParam String stock,@RequestParam Integer pageNumber, @RequestParam Integer pageSize) throws UserException{
		Page<Product> res = productService.getAllProducts(category,
